...
<html>
  ...
  <body>
  	<form action="AddDescription" enctype="multipart/form-data" method="post" name="form" onsubmit="return check()" class="definewidth m20">
		<table class="table table-bordered table-hover definewidth m10">
		    ...
		    <tr>
		        ...
		        <td><input type="file" name="introduce"/></td>
		    </tr>
		    <tr>
