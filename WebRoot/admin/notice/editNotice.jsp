...
<html>
  ...
  <body>
  	<form action="UpdateNotice" method="post" name="form" onsubmit="return check()" class="definewidth m20">
		<table class="table table-bordered table-hover definewidth m10">
			<input type="text" name="id" value="<%=notice.getId() %>"/>
		    <tr>
		    ...
		    <tr>
		        ...
		        <td><textarea name="content"><%=notice.getContent() %></textarea></td>
		    </tr>
		    <tr>
