	     ...
	     <span class="icon-bar"></span>
	      ...
	      <div class="nav-collapse">
	          <ul class="nav nav-pills">
				...
				<li class="active divider-vertical"><a href="jsp/main/person.jsp">个人中心</a></li>
	          </ul>
	  			...
	  			<div class="tab-content">
	    			<div class="tab-pane active" id="tabC1">
	    				<ul>
		      			...
		      			%>
		      				<li>
			      				<span><%=i+1%>、<%=source.getFileName()%></span>
			      				<span><button class="btn">下载</button></span>
			      			</li>
			      		<%
			      			}
			      		%>
	    			...
	    			<div class="tab-pane" id="tabC2">
	      				<div class="tab-pane active" id="tabC1">
			      			...
			      			%>
				      			<li>
				      				<span><%=i+1 %>、<%=course.getFileName()%></span>
				      				<span><button class="btn">下载</button></span>
				      			</li>
				      		<% } %>
			      			</ul>
					...
					<form class="form-horizontal" action="AddResource" method="post" enctype="multipart/form-data">
						...
						<label class="control-label">File input</label>
			 			...
			 			<div class="control-group warning">
			 				...
			 				<div class="controls">
								<input type="radio" name="kind" value="MySql_source"/>MySql<br/>
								<input type="radio" name="kind" value="SQLServer_source"/>SQLServer<br/>
								<input type="radio" name="kind" value="Oracle_source"/>Oracle<br/>
							</div>
			 			</div>
			 			<div class="control-group warning">
