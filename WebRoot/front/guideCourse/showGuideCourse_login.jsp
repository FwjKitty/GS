<%@ page language="java" import="java.util.*,beans.Users,beans.GuideCourses" pageEncoding="UTF-8"%>
<%
				...
				<div class="nav-collapse">
					<ul class="nav pull-left">
						<li class="divider-vertical"><a href="Main">首页</a></li>
          				<li class="divider-vertical active"><a href="UserGetAllCourse?page=1&kind=mysql">学习课程</a></li>
		...
		<div class="row-fluid">
			<div class="span2">
				<ul class="nav nav-tabs nav-stacked" >
					...
					<li>
           				<a href="UserGetAllGuideCourse?page=1&name=mysql">MySOL</a>
           			</li>
           			<li>
           				<a href="UserGetAllGuideCourse?page=1&name=sqlserver">SQLServer</a>
           			</li>
           			<li>
           				<a href="UserGetAllGuideCourse?page=1&name=oracle">Oracle</a>
           			</li>
			...
			<div class="span10">	
				...
				%>
					<div class="ih-item circle effect1">
						<a href="UserGetGuideCourse?id="<%=guideCourse.getId() %>">
							<div class="spinner"></div>
							<div class="img"><img src="<%=guideCourse.getImage() %>" alt="光数之家"></div>
							<div class="info">
								<div class="info-back">
									<h3><%=guideCourse.getTitle() %></h3>
									<p><%=guideCourse.getIntroduce() %></p>
								</div>
							</div>
						</a>
					</div>
				...
				<div class="row-fluid">
					<ul class="pager pull-left">
						<li><a href="UserGetAllGuideCourse?page=<%=lastpage %>&kind=<%=guideCourse.getName() %>">上一页</a></li>
						<li><a href="UserGetAllGuideCourse?page=<%=nextpage %>&kind=<%=guideCourse.getName() %>">下一页</a></li>
					</ul>
				</div>
			</div>
		</div>
